...
def cvt_codec_main(args):
	...
	if args.clean_bak:
		...
		args.inc_exts = DEFAULT_CONF['inc_exts'] if args.inc_exts is None else set(args.inc_exts) | DEFAULT_CONF[
			'inc_exts']
		args.exc_dirs = DEFAULT_CONF['exc_dirs'] if args.exc_dirs is None else set(args.exc_dirs) | DEFAULT_CONF[
			'exc_dirs']
